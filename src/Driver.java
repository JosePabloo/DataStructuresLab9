...
public class Driver<K>
{
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        ArrayList<Cargo> bst = (ArrayList<Cargo>) boxes.clone(); //Created this for the BST
        ...
        System.out.println("BST Short took: " + bst(bst) + " nano seconds."); //this is to time the bst
     ...
     //   if (!bst(bst))
       //     System.out.println("HEY!!! BST.sort() didn't sort!!!");
        ...
        System.out.println("A search of BST for  " + targets.size() + " items took: " + bst(boxes) + " nano seconds.");                

    }
    
    //Sorting 

    private static long bst(ArrayList<Cargo> boxes) {
	...
	//Searching 
    private static long searchBST(ArrayList<Cargo> boxes, ArrayList<Cargo> targets) {
        long start = System.nanoTime();
        BST bt = new BST();
        for(int i = 0; boxes.size() > i; i++ ){
     	   bt.add(boxes.get(i));
